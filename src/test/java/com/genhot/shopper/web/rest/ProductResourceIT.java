...
class ProductResourceIT {
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).inventory(UPDATED_INVENTORY);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).price(UPDATED_PRICE).inventory(UPDATED_INVENTORY);
