...
import reducer, { getEntities, getEntity, reset } from './order-stat.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERSTAT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERSTAT actions', async () => {
      const expectedActions = [
        {
