  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="shopperApp.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
            <Translate contentKey="shopperApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('shopperApp.category.name')}
                id="category-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('shopperApp.category.description')}
              ...
              />
              <ValidatedField
                label={translate('shopperApp.category.status')}
                id="category-status"
                name="status"
                data-cy="status"
                type="select"
              >
                {categoryStatusValues.map(categoryStatus => (
                  <option value={categoryStatus} key={categoryStatus}>
                    {translate('shopperApp.CategoryStatus.' + categoryStatus)}
                  </option>
                ))}
              </ValidatedField>
